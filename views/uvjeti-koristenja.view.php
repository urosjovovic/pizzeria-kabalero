...
<div class="container py-5">
  ...
  <h2>Terms and Conditions of <span class="website_url">https://www.pizzeria-kabalero.hr</span></h2>

<p>The following terms and conditions (collectively, these "Terms and Conditions") apply to your use of <span class="website_url">https://www.pizzeria-kabalero.hr</span>, including any content, functionality and services offered on or via <span class="website_url">https://www.pizzeria-kabalero.hr</span> (the "Website").</p>
...
<p>Your use of the Website is subject to all applicable laws and regulations, and you are solely responsible for the substance of your communications through the Website. These Terms and Conditions were created by <a href="https://www.termsconditionstemplate.net">Terms Conditions Template Generator</a>.</p>
...
<p>By accepting these Terms and Conditions, you acknowledge and agree that all content presented to you on this Website is protected by copyrights, trademarks, service marks, patents or other proprietary rights and laws, and is the sole property of <span class="website_name">Pizzeria Kabalero</span>.</p>
...
<p>Your use of <span class="website_name">Pizzeria Kabalero</span> is at your sole risk. The Website is provided "as is" and "as available". We disclaim all warranties of any kind, express or implied, including, without limitation, the warranties of merchantability, fitness for a particular purpose and non-infringement.</p>
...
<p>This Terms and Conditions will become effective in relation to you when you create a <span class="website_name">Pizzeria Kabalero</span> account or when you start using the <span class="website_name">Pizzeria Kabalero</span> and will remain effective until terminated by you or by us. </p>

<p><span class="website_name">Pizzeria Kabalero</span> reserves the right to terminate this Terms and Conditions or suspend your account at any time in case of unauthorized, or suspected unauthorized use of the Website whether in contravention of this Terms and Conditions or otherwise. If <span class="website_name">Pizzeria Kabalero</span> terminates this Terms and Conditions, or suspends your  account for any of the reasons set out in this section, <span class="website_name">Pizzeria Kabalero</span> shall have no liability or responsibility to you.</p>

<h3>Assignment</h3>

<p><span class="website_name">Pizzeria Kabalero</span> may assign this Terms and Conditions or any part of it without restrictions. You may not assign this Terms and Conditions or any part of it to any third party.</p>

<h3>Governing Law</h3>

<p>These Terms and Conditions and any dispute or claim arising out of, or related to them, shall be governed by and construed in accordance with the internal laws of the <span class="country">hr</span> without giving effect to any choice or conflict of law provision or rule.</p>

<p>Any legal suit, action or proceeding arising out of, or related to, these Terms of Service or the Website shall be instituted exclusively in the federal courts of <span class="country">hr</span>.</p>
</div>
<!-- Page content end -->
